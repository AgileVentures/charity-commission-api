class CharitiesController < ApplicationController
  ...
  # GET /charities.json
  def index
    @charities = Charity.search(params, 50)
  end
  ...
  private
    ...
    def charity_params
      params.require(:charity).permit(:regno, :subno, :name, :orgtype, :gd, :aob, :aob_defined, :nhs, :ha_no, :corr, :add1, :add2, :add3, :add4, :add5, :postcode, :phone, :fax, :lon, :lat, :update_at)
    end
end
