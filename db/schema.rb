...
ActiveRecord::Schema.define(version: 20190212072741) do
  ...
  create_table "charity_remove_refs", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "code", limit: 3, default: "", null: false, collation: "latin1_swedish_ci"
    t.string "text", limit: 25, collation: "latin1_swedish_ci"
    t.timestamp "created_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.timestamp "updated_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
  end

  create_table "charity_trustees", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "regno", limit: 14, default: "0", null: false, collation: "latin1_swedish_ci"
    t.string "trustee", default: "", null: false, collation: "latin1_swedish_ci"
    t.timestamp "created_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.timestamp "updated_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
  end
